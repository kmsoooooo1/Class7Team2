...
LOCK TABLES `team2_basket` WRITE;
/*!40000 ALTER TABLE `team2_basket` DISABLE KEYS */;
INSERT INTO `team2_basket` VALUES (1,'coduo25','a-10',8,'','일반포장'),(2,'coduo25','a-10',10,'','퀵서비스'),(3,'coduo25','a-10',6,'','지하철'),(4,'coduo25','a-11',4,'','퀵서비스'),(5,'coduo25','a-100',4,'','지하철'),(6,'coduo25','a-100',3,'','고속버스'),(7,'coduo25','a-200',15,'','일반포장'),(8,'coduo25','a-200',8,'','퀵서비스');
/*!40000 ALTER TABLE `team2_basket` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `team2_board` (
  ...
  `b_p_code` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`b_idx`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `team2_board` WRITE;
/*!40000 ALTER TABLE `team2_board` DISABLE KEYS */;
INSERT INTO `team2_board` VALUES (1,'Notice','공지사항 1','null','<p style=\"text-align: center;\" align=\"center\">에디터에 기본으로 삽입할 글(수정 모드)이 없다면 이 value 값을 지정하지 않으시면 됩니다.ㅇㅇ</p><p style=\"text-align: center;\" align=\"center\">&nbsp;</p><p>&nbsp;</p><div style=\"text-align: center;\" align=\"center\"><img src=\"/Team2/upload/multiupload/20200506090355d1401107-1328-4596-a710-300e5d65671b.jpg\r\n\" title=\"img_main_gnb01_on.jpg\"></div><div style=\"text-align: center;\" align=\"center\"><img src=\"/Team2/upload/multiupload/202005060903551aa4ef23-03b3-4642-a2e0-cbf09d28ce7c.png\r\n\" title=\"jepoom.png\"></div><div style=\"text-align: center;\"><br></div><p>&nbsp;</p>',1,0,28,'2020-05-06 09:04:46','0:0:0:0:0:0:0:1',',1588723486755.PNG,1588723486757.PNG,1588723486758.PNG,1588723486759.PNG,1588723486760.PNG',NULL),(2,'Notice','공지사항2','test','<p style=\"text-align: center;\" align=\"center\">아니아니 이러면 안되지</p><p style=\"text-align: center; \" align=\"center\">&nbsp;</p><p>&nbsp;</p><div style=\"text-align: center;\" align=\"center\"><img src=\"/Team2/upload/multiupload/202005061008055f2a0388-bbb1-4cf1-87c2-050edb55a6fb.gif\r\n\" title=\"btn_family.gif\"></div><div style=\"text-align: center;\" align=\"center\"><br></div><p>&nbsp;</p><p style=\"text-align: center; \" align=\"center\">&nbsp;</p><p style=\"text-align: center; \" align=\"center\"><img src=\"/Team2/upload/multiupload/20200506100805596b4d21-4d1a-437f-9352-7530f2479602.gif\r\n\" title=\"btn_lnb_search.gif\"></p>',2,0,12,'2020-05-06 10:08:13','0:0:0:0:0:0:0:1','',NULL),(3,'Review','배송에 아주아주 만족합니다','test','<p>배송이 빠르고 애기들이 아주아주 건강하게 오네요!</p><p>박스를 다 뜯고 탈출했어요.</p>',3,0,0,'2020-05-07 09:59:52','0:0:0:0:0:0:0:1','1588813192035.PNG','a-11'),(4,'Review','eklasjkldf','test','에디터에 기본으로 삽입할 글(수정 모드)이 없다면 이 value 값을 지정하지 않으시면 됩니다.asdfdfsa',4,0,0,'2020-05-07 10:07:19','0:0:0:0:0:0:0:1','','a-11'),(5,'Review','배송에 아주아주 만족합니다','null','asdfdsa',5,0,0,'2020-05-07 11:21:26','0:0:0:0:0:0:0:1','','a-10');
/*!40000 ALTER TABLE `team2_board` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `team2_goods` (
  ...
  `g_name` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `g_code` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `g_image` text COLLATE utf8_unicode_ci NOT NULL,
  `g_amount` int(11) NOT NULL,
...
-- Dump completed on 2020-05-07 17:27:40
