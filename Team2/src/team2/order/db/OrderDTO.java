...
public class OrderDTO {
	...
	public String getO_receive_zipcode() {
		return o_receive_zipcode;
	}
	public void setO_receive_zipcode(String o_receive_zipcode) {
		this.o_receive_zipcode = o_receive_zipcode;
	}
