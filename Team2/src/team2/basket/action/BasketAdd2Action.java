...
public class BasketAdd2Action implements Action {
...
//		System.out.println(selectedValues);
		...
		int chkSize = (splitSelectedAmounts.length-1);
		
		System.out.println("상품 개수 " +chkSize);
		...
		out.println("<script>");
		out.println("var goBasket = confirm('바로 구매하시겠습니까?');");
		out.println("if(goBasket){");
		out.println("location.href='./BasketList.ba?chk=ok&chkSize="+chkSize+"';");
