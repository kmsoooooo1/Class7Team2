...
<body>
	...
	<div class="member_div">
		<div class="content">
			...
			<div class="myshop">
				...
				<div class="top_div">
					<div class="user_left">
						...
						<div class="userInfo">
							<span class="userName"><b><%=name%></b></span> <span
								class="groupName">1% 바로 적립</span>
						</div>
					</div>
					<!-- 회원 정보 -->
					...
					<div class="userRight">
						...
						<div class="userButton">
							<a href="./MemberUpdate.me"><i class='fas fa-user-plus'></i>회원
								정보 수정</a> <a href="./MemberDelete.me"><i
								class="fas fa-user-slash"></i>회원 탈퇴</a>

						</div>
						<div class="mileage_div">
							<ul>
								<!-- 총주문 -->
								<li><strong class="mileage_strong">총 주문</strong> <strong
									class="mileage_strong2"> <span class="mileage_span">0원</span>

										<span class="mileage_span2">(0회)</span>
								</strong></li>
								<!-- 가용 적립금 -->
								<li><strong class="mileage_strong">적립금</strong> <strong
									class="mileage_strong2"> <span class="mileage_span"><%=mdto.getMileage()%>원</span>
								</strong> <a href="#">조회</a></li>
								<!-- 쿠폰 -->
								<li><strong class="mileage_strong">쿠폰</strong> <strong
									class="mileage_strong2"> <span class="mileage_span">0개</span>
								</strong> <a href="${pageContext.request.contextPath}/member/coupon.jsp"
				...
				<div class="benefit_div">
					...
					<div>
						...
						<div class="benefit_contents">
							<p>
								<span class="benefit_span" style="font-size: 13px;"> "저희
									쇼핑몰을 이용해 주셔서 감사합니다." <strong class="benefit_strong"> <span>
											<span><%=name%></span>
									</span>
								</strong> "회원님은" <strong> <span>[1%바로 적립]</span>
								</strong> "등급 회원이십니다."
								</span>
							</p>
						</div>
				...
				<div class="order_div">
					<h3>
						<span>주문처리 현황</span> <span class="desc"><em>(최근 3개월)</em></span>
					</h3>
					<div class="contents">
						<ul class="order_ul">
							<li><span class="order_span">입금전</span> <a href="#"
								style="color: black; text-decoration: none;"> <span><%=data[0]%></span>
							</a></li>
							<li><span class="order_span">배송준비중</span> <a href="#"
								style="color: black; text-decoration: none;"> <span><%=data[1]%></span>
							</a></li>
							<li><span class="order_span">배송중</span> <a href="#"
								style="color: black; text-decoration: none;"> <span><%=data[2]%></span>
							</a></li>
							<li><span class="order_span">배송완료</span> <a href="#"
								style="color: black; text-decoration: none;"> <span><%=data[3]%></span>
							</a></li>
						</ul>
						<!-- 취소,교환,반품 -->
						<ul class="cs">
							<li><span>취소:</span> <a href="#"> </a></li>
							<li><span>교환:</span> <a href="#"> </a></li>
							<li><span>반품:</span> <a href="#"> </a></li>
						</ul>
					</div>
				</div>
				...
				<div class="info_div">
					<h3>
						주문상품정보 <a href="./OrderList.or" class="seemore">더보기>></a>
					</h3>
					<div class="contents">
				...
				<div class="coupon_div">
					<h3>
						내 쿠폰 목록 <a href="#" class="seemore">더보기>></a>
					</h3>
					<div class="contents">
						<table border="1" summary>
						...
						<p class="empty">보유하고 계신 쿠폰 내역이 없습니다.</p>
					</div>
				</div>
				...
				<div class="recent_div">
					<h3>
						최근 본 상품 <a href="./recentView.me" class="seemore">더보기>></a>
					</h3>
					<div class="contents">
			...
			<div class="board_div">
				<h3>
					내 게시글 <a href="#" class="seemore">더보기>></a>
				</h3>
				<div class="contents">
					<table border="1" summary>
