	...
	<div id="main_body">
		...
		<div class="center_banner">
			<div class="banner_img">
				<a href="./aHospital.bo"> <img
					src="${pageContext.request.contextPath}/img/navi.png" alt="Navi"
					class="image">
				</a>
				<div class="overlay">동물병원 정보</div>
			</div>
			<div class="banner_img">
				<a href="./AnimalList.an?category=파충류&sub_category=거북"> <img
					src="${pageContext.request.contextPath}/img/turt.png" alt="Turtle"
					class="image">
				</a>
				<div class="overlay">거북이</div>
			</div>
			<div class="banner_img">
				<a href="./AnimalList.an?category=파충류&sub_category=도마뱀"> <img
					src="${pageContext.request.contextPath}/img/gaeko.png" alt="Gaeko"
					class="image">
				</a>
				<div class="overlay">개코</div>
			</div>
			<div class="banner_img">
				<a href="./AnimalList.an?category=양서류"> <img
					src="${pageContext.request.contextPath}/img/fl.png" alt="Flog"
					class="image">
				</a>
				<div class="overlay">개구리</div>
			</div>
			<div class="banner_img">
				<img src="${pageContext.request.contextPath}/img/c2.jpg" alt="Flog"
					class="image">
				...
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<a href="./AnimalDetail.an?a_code=<%=adto.getA_code()%>"> <img
							src="${pageContext.request.contextPath}/upload/multiupload/<%=adto.getA_thumbnail()%>">
						</a>
					</div>
		...
		<!-- Swiper JS -->
		<script
			src="${pageContext.request.contextPath}/js/swiper/swiper.min.js"></script>
			...
			<div class="main">
				...
				<div id="myBtnContainer">
					<button class="btn active" onclick="filterSelection('all')">
						전체보기</button>
					<button class="btn" onclick="filterSelection('Lizard')">
						도마뱀</button>
					<button class="btn" onclick="filterSelection('Turtle')">
						거북이</button>
				...
				<div class="row">
					<div class="column Lizard">
						<div class="content">
							...
							<h4>술라웨시 워터 스킨크</h4>
							<p>
								악어와 닮은 생김새로 크로커다일 스킨크라도 불리는 스킨크입니다.<br> 물을 좋아하지만 성격이 예민하고
								겁이 많습니다.
							</p>
						</div>
					</div>
					<div class="column Lizard">
						<div class="content">
							<img src="${pageContext.request.contextPath}/img/2.jpg"
								alt="Mountains" alt="Lights" style="width: 100%">
							<h4>사바나 모니터 베이비</h4>
							<p>
								지능이 매우 높고 순한종으로 애완파충류 중 강아지와 같은 입지를<br> 가지고있습니다. 특히
								'개바나'라고도 불립니다.
							</p>
						</div>
					</div>
					<div class="column Flog">
						<div class="content">
							<img src="${pageContext.request.contextPath}/img/3.jpg"
								alt="Mountains" alt="Nature" style="width: 100%">
							<h4>자이언트 픽시 프로그</h4>
							<p>
								뭐든 잘먹는 식성과20cm까지 자라는 크기로 많은 매니아들이<br> 좋아하는 종이기도 합니다. 누구나 쉽게
								키울수있는 귀여운 개구리입니다.
							</p>
						</div>
					</div>
					...
					<div class="column Flog">
						<div class="content">
							<img src="${pageContext.request.contextPath}/img/4.jpg"
								alt="Mountains" alt="Car" style="width: 100%">
							<h4>브라운[탄]팩맨 베이비</h4>
							<p>
								생김새가 게임 '팩맨'을 닮았다하여 팩맨이라고 불리는 개구리로<br> 눈 앞에 보이는 먹이는 무엇이든
								통채로 잡아먹는 모습이 매우 귀엽습니다.
							</p>
						</div>
					</div>
					<div class="column Turtle">
						<div class="content">
							...
							<h4>텍사스 테라핀</h4>
							<p>
								용골이 큰 편이며 등갑은 어두운 갈색에서 밝은 갈색으로 나타납니다.<br> 사료도 가리는것 없이 아주
								잘먹습니다.
							</p>
						</div>
					</div>
					<div class="column Flog">
						<div class="content">
							<img src="${pageContext.request.contextPath}/img/6.jpg"
								alt="Mountains" alt="Car" style="width: 100%">
							<h4>부쉬벨드 레인프록</h4>
							<p>
								흔히 알려진 사막 비개구리와 유사한 종입니다. 평상시에는 흙 안쪽으로<br> 숨어있다가, 비가 오면 나와
								먹이활동을 하는 개구리입니다.
							</p>
						</div>
					</div>
					...
					<div class="column Lizard">
						<div class="content">
							...
							<p>
								주로 곤충과 바나나를 즐겨 먹는 잡식성 파충류로 동물성 성분이 강한<br> 개사료를 잘먹습니다.
							</p>
						</div>
					</div>
					<div class="column Turtle">
						<div class="content">
							<img src="${pageContext.request.contextPath}/img/8.jpg"
								alt="Mountains" alt="Car" style="width: 100%">
							<h4>화이트 레오파드 육지거북</h4>
							<p>
								일반 개체에 비해 체색이 밝으며,스큠의 가장자리에서 퍼지는<br> 방사상의 검은선이 매력적인 개체들입니다.
							</p>
						</div>
					</div>
					<div class="column Lizard">
						<div class="content">
							<img src="${pageContext.request.contextPath}/img/9.jpg"
								alt="Mountains" alt="Car" style="width: 100%">
