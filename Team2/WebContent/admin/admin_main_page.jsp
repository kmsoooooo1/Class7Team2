...
<body>
	...
	<h2>관리자 메인페이지</h2>
		...
		<tr>
			<th> 상품 파트 </th>
			<td colspan="3"><a href="./GoodsList.ag?category=all"> 모든 상품 리스트 </a></td>
			<td colspan="3"><a href="./GoodsAdd.ag">사육용품 추가하기</a></td>
		</tr>
		<!-- 관리자 멤버 파트 -->
		<tr>
			<th> 멤버 파트 </th>
		...
		<tr>
			<th> 쿠폰 파트 </th>
			<td colspan="3"><a href="./CouponAdd.ac">새로운 쿠폰 등록하기</a></td>
			<td colspan="3"><a href="#"> 쿠폰 리스트 보기 </a></td>
		</tr>	
		<!-- 관리자 게시판 파트 -->
		<tr>
			<th> 게시판 파트 </th>
