...
<body>
	...
	<form action="" method="post" enctype="multipart/form-data"> 
		<table border="1">
			...
			<tr>
				<td> 동물 코드 </td>
				<td> <input type="text" name="animal_code"> </td>
			</tr>
			<tr>
				<td rowspan="3"> 동물 기본 이미지(3장)</td>
...
<script type="text/javascript">
	...
	function categoryChange(e){
		...
		var empty_list = ["서서브 종을 선택해주세요"]; //빈 리스트, 서서브 카테고리에 뿌려주기 위한 빈 리스트
		...
		if(e.value == "파충류") {
			var d = animal_p; 
			var em = empty_list; //서서브에 뿌려줄 빈 리스트
		}
		//카테고리에서 양서류를 선택했을시
		else if(e.value == "양서류") {
			var d = animal_y;
			var em = empty_list; //서서브에 부려줄 빈 리스트
		}
	...
	function sub_categoryChange(e){
		...
		if(e.value == "게코 도마뱀") var d = animal_geDo;
		else if(e.value == "뱀") var d = animal_snake;
		else if(e.value == "거북") var d = animal_turtle;
